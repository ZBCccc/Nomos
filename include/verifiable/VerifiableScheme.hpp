...
class VerifiableGatekeeper : public nomos::GateKeeper {
 public:
   ...
   */
  VerifiableTrapdoor genTokenVerifiable(
 ...
 private:
  ...
  std::unordered_map<std::string, std::vector<std::string> >
      m_xtag_cache;  // Cache for (w,id) -> xtags
};
...
class VerifiableServer : public nomos::Server {
 public:
   ...
   */
  std::pair<std::vector<nomos::sEOp>, VerificationProof> searchVerifiable(
      const VerifiableTrapdoor& trapdoor);
